...
V3.0.0 brings in support for 2 more paid drivers bringing our total to 9!  Welcome aboard FlowRoute, Plivo.  See the full list of changes in the [changelog.](https://github.com/SimpleSoftwareIO/simple-sms/blob/develop/CHANGELOG.md)
